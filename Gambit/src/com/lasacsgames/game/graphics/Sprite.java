...
public class Sprite
{
	...
	{ new Sprite(16, 10, 1, SpriteSheet.tiles), new Sprite(16, 10, 0, SpriteSheet.tiles), new Sprite(16, 11, 0, SpriteSheet.tiles), new Sprite(16, 11, 1, SpriteSheet.tiles), new Sprite(16, 11, 2, SpriteSheet.tiles), new Sprite(16, 10, 2, SpriteSheet.tiles), new Sprite(16, 9, 2, SpriteSheet.tiles), new Sprite(16, 9, 1, SpriteSheet.tiles), new Sprite(16, 9, 0, SpriteSheet.tiles), new Sprite(16, 12, 1, SpriteSheet.tiles), new Sprite(16, 13, 1, SpriteSheet.tiles), new Sprite(16, 12, 0, SpriteSheet.tiles), new Sprite(16, 13, 0, SpriteSheet.tiles), new Sprite(16, 6, 0, SpriteSheet.tiles) };
